<?
//	require ('./php/urlcheck.php');
	
//	require ('./php/tabs.php');
...
$custschool = "Customer Location";
$custline3 = "";
$unitlocname = "Unit Name";
$unitlocstreet = "Street Address";
$unitloczip = "City, State, Zip";
$division = "1";
$sapnumber = "";
$ordertakenby = "";
$employeenumber = "";
			...
			<fieldset id='clientinfo' class='fields'>
				...
				<table class='checkboxes'>
					<tr>
						...
						<td>
							<input class='underline' name='startdate' type='text' tabindex=5 value='" . $startdate . "' />
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<input style='visibility:hidden;' name='isdeleted' type='text' value='" . $isdeleted . "' />
						</td>
						<td>
				...
				<table class='checkboxes'>
					...
					<tr>
						...
						<td rowspan='2' colspan='3'>
							<textarea class='outline white' name='worktobedone' rows='5' cols='75'>" . $worktobedone . "</textarea>
						</td>
					</tr>
					<tr>
					</tr>
			...
			<fieldset id='laborinfo' class='fields'>
				...
				<table class='checkboxes'>
					...
					<tr>
						...
						<td>
							<input class='underline' name='datecompleted' type='text' value='" . $datecompleted . "' />
						</td>
					</tr>
				</table>
			</fieldset>
			<fieldset class='fields' style='border: none;'>
				<input type='submit' class='detail button' name='button' value='Submit'/>
